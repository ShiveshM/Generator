...
void RandomGen::SetSeed(long int seed)
{
  ...
  PythiaSingleton * fPythia8 = PythiaSingleton::Instance();
  fPythia8->Pythia8()->readString("Random:setSeed = on");
  fPythia8->Pythia8()->settings.mode("Random:seed", seed);
  ...
  LOG("Rndm", pINFO) << "PYTHIA8  seed = " << fPythia8->Pythia8()->settings.mode("Random:seed");
}
//____________________________________________________________________________
